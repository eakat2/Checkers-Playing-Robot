...
module top ;
    ...
    SPI_Slave_v2_70_4 SPI (
        .clock(Net_1437),
        .miso(Net_1448),
        .miso_oe(Net_1441),
        .mosi(Net_1433),
        .reset(1'b0),
        .rx_interrupt(Net_1454),
        .sclk(Net_1434),
        .sdat(Net_1439),
        .ss(Net_1435),
        .tx_interrupt(Net_1438));
    defparam SPI.NumberOfDataBits = 8;
    defparam SPI.ShiftDir = 0;


	cy_clock_v1_0
		#(.id("f6d39213-63d4-4831-ac91-3e5fcb60abaf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3b24494-d50d-47b5-bfb5-88fb2bc5e62d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1925108b-04ce-49f8-bbf6-c1335693309b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d8dcbd3d-d61e-4309-ba06-13e2b2398397"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_5 UART_1 (
        ...
        .rx_clk(Net_1475),
        .rx_data(Net_1476),
        .rx_interrupt(Net_1477),
        .tx(Net_1478),
        .tx_clk(Net_1479),
        .tx_data(Net_1480),
        .tx_en(Net_1481),
        .tx_interrupt(Net_1482));
